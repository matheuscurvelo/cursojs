...
var geraSimbolo = function geraSimbolo() {
  var min = [33, 58, 91, 123];
  var max = [48, 65, 97, 127];
  var random = Math.floor(Math.random() * min.length);
